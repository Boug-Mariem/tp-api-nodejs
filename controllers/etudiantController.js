...
exports.createEtudiant = async (req, res) => {
    try {
        ...
        //defi 1
        const etudiant1 = await Etudiant.findOne({nom :req.body.nom , prenom :req.body.prenom}) 
        if (etudiant1) {
            return res.status(404).json({
                success: false,
                message: 'Nom et prenom sont deja existant'
            });
        }
...
exports.searchEtudiants  = async (req, res) => {
    try {
        // Étape 1: Récupérer l'ID depuis les paramètres de l'URL
        // req.params contient les paramètres de l'URL
        console.log('🔍 Recherche de l\'ID:', req.query.q);
        
        // Étape 2: Chercher l'étudiant par son
...
//defi 3
exports.desactivateEtudiant = async (req, res) => {
    try {
        console.log('🗑️ Suppression de l\'ID:', req.params.id);
